...
export abstract class TSocketServer extends TAbstractSocket
{
     ...
     */
    /// @override
    protected CloseInheritable(GracefulTimeout: number = 500): Promise<void>
    {
...
export abstract class TSocketClient extends TAbstractSocket
{
    ...
    /// @override
    protected CloseInheritable(): Promise<void>
    {
        return super.CloseInheritable()
            .then(() =>
            {
...
export class TTcpClient extends TSocketClient
{
    ...
    /// @override & @overload
    Connect(RemoteAddr: TInetAddr | string): Promise<TSocketConnection>
    {
